...
mod test {
  ...
  #[test]
  fn blog64_vectors() {
    assert_eq!(blog64(1793), 0x159dc71e24d32daf);
    assert_eq!(blog64(0x678dde6e5fd29f05), 0x7d6373ad151ca685);
  }

  #[test]
  fn bexp64_vectors() {
    assert_eq!(bexp64(0x159dc71e24d32daf), 1793);
