...
pub static av1_default_dc_sign_cdfs: [[[[u16; cdf_size!(2)]; DC_SIGN_CONTEXTS]; PLANE_TYPES]; TOKEN_CDF_Q_CTXS] = [
                              [ [
                                    cdf!(128 * 125),
                                    cdf!(128 * 102),
                                    cdf!(128 * 147),
...
pub static av1_default_txb_skip_cdfs: [[[[u16; cdf_size!(2)]; TXB_SKIP_CONTEXTS]; TxSize::TX_SIZES]; TOKEN_CDF_Q_CTXS] = [ 
                                               [ [ cdf!(31849),
                                                   cdf!(5892),
                                                   cdf!(12112),
                                                   cdf!(21935),
...
pub static av1_default_eob_extra_cdfs: [[[[[u16; cdf_size!(2)]; EOB_COEF_CONTEXTS]; PLANE_TYPES]; TxSize::TX_SIZES]; TOKEN_CDF_Q_CTXS] = [
                                [ [ [
                                        cdf!(16961),
                                        cdf!(17223),
                                        cdf!(7621),
...
pub static av1_default_eob_multi16_cdfs: [[[[u16; cdf_size!(5)]; 2]; PLANE_TYPES]; TOKEN_CDF_Q_CTXS] = [ 
                [ [ cdf!(840, 1039, 1980, 4895),
                    cdf!(370, 671, 1883, 4471) ],
                  [ cdf!(3247, 4950, 9688, 14563),
                    cdf!(1904, 3354, 7763, 14647) ] ],
                [ [ cdf!(2125, 2551, 5165, 8946),
                    cdf!(513, 765, 1859, 6339) ],
                  [ cdf!(7637, 9498, 14259, 19108),
                    cdf!(2497, 4096, 8866, 16993) ] ],
                [ [ cdf!(4016, 4897, 8881, 14968),
                    cdf!(716, 1105, 2646, 10056) ],
                  [ cdf!(11139, 13270, 18241, 23566),
                    cdf!(3192, 5032, 10297, 19755) ] ],
                [ [ cdf!(6708, 8958, 14746, 22133),
                    cdf!(1222, 2074, 4783, 15410) ],
                  [ cdf!(19575, 21766, 26044, 29709),
                    cdf!(7297, 10767, 19273, 28194) ] ] ];

pub static av1_default_eob_multi32_cdfs: [[[[u16; cdf_size!(6)]; 2]; PLANE_TYPES]; TOKEN_CDF_Q_CTXS] = [ 
                [ [ cdf!(400, 520, 977, 2102, 6542),
                    cdf!(210, 405, 1315, 3326, 7537) ],
                  [ cdf!(2636, 4273, 7588, 11794, 20401),
                    cdf!(1786, 3179, 6902, 11357, 19054) ] ],
                [ [ cdf!(989, 1249, 2019, 4151, 10785),
                    cdf!(313, 441, 1099, 2917, 8562) ],
                  [ cdf!(8394, 10352, 13932, 18855, 26014),
                    cdf!(2578, 4124, 8181, 13670, 24234) ] ],
                [ [ cdf!(2515, 3003, 4452, 8162, 16041),
                    cdf!(574, 821, 1836, 5089, 13128) ],
...
pub static av1_default_eob_multi64_cdfs: [[[[u16; cdf_size!(7)]; 2]; PLANE_TYPES]; TOKEN_CDF_Q_CTXS] = [ 
...
pub static av1_default_eob_multi128_cdfs: [[[[u16; cdf_size!(8)]; 2]; PLANE_TYPES]; TOKEN_CDF_Q_CTXS] = [
...
pub static av1_default_eob_multi256_cdfs: [[[[u16; cdf_size!(9)]; 2]; PLANE_TYPES]; TOKEN_CDF_Q_CTXS] = [
      ...
      [ [ cdf!(3089, 3920, 6038, 9460, 14266, 19881, 25766, 29176),
        ...
        [ cdf!(11514, 13794, 17480, 20754, 24361, 27378, 29492, 31277),
          cdf!(6571, 9610, 15516, 21826, 29092, 30829, 31842,
                     32708) ] ],
      [ [ cdf!(5348, 7113, 11820, 15924, 22106, 26777, 30334, 31757),
        ...
        [ cdf!(23110, 24597, 27140, 28894, 30167, 30927, 31392, 32094),
          cdf!(9998, 17661, 25178, 28097, 31308, 32038, 32403,
                     32695) ] ]
    ];

pub static av1_default_eob_multi512_cdfs: [[[[u16; cdf_size!(10)]; 2]; PLANE_TYPES]; TOKEN_CDF_Q_CTXS] = [ 
                  [ [ cdf!(641, 983, 3707, 5430, 10234, 14958, 18788,
                                 23412, 26061),
                     cdf!(3277, 6554, 9830, 13107, 16384, 19661, 22938,
                                 26214, 29491) ],
                   [ cdf!(5095, 6446, 9996, 13354, 16017, 17986, 20919,
                                 26129, 29140),
                     cdf!(3277, 6554, 9830, 13107, 16384, 19661, 22938,
                                 26214, 29491) ] ],
                 [ [ cdf!(1230, 2278, 5035, 7776, 11871, 15346, 19590,
                                 24584, 28749),
                     cdf!(3277, 6554, 9830, 13107, 16384, 19661, 22938,
                                 26214, 29491) ],
                   [ cdf!(7265, 9979, 15819, 19250, 21780, 23846, 26478,
                                 28396, 31811),
                     cdf!(3277, 6554, 9830, 13107, 16384, 19661, 22938,
                                 26214, 29491) ] ],
                 [ [ cdf!(2624, 3936, 6480, 9686, 13979, 17726, 23267,
                                 28410, 31078),
                     cdf!(3277, 6554, 9830, 13107, 16384, 19661, 22938,
                                 26214, 29491) ],
                   [ cdf!(12015, 14769, 19588, 22052, 24222, 25812,
                                 27300, 29219, 32114),
                     cdf!(3277, 6554, 9830, 13107, 16384, 19661, 22938,
                                 26214, 29491) ] ],
                 [ [ cdf!(5927, 7809, 10923, 14597, 19439, 24135, 28456,
                                 31142, 32060),
                     cdf!(3277, 6554, 9830, 13107, 16384, 19661, 22938,
                                 26214, 29491) ],
                   [ cdf!(21093, 23043, 25742, 27658, 29097, 29716,
                                 30073, 30820, 31956),
                     cdf!(3277, 6554, 9830, 13107, 16384, 19661, 22938,
                                 26214, 29491) ] ] ];

pub static av1_default_eob_multi1024_cdfs: [[[[u16; cdf_size!(11)]; 2]; PLANE_TYPES]; TOKEN_CDF_Q_CTXS] = [
                 [ [ cdf!(393, 421, 751, 1623, 3160, 6352, 13345, 18047,
                                 22571, 25830),
                     cdf!(2979, 5958, 8937, 11916, 14895, 17873, 20852,
                                 23831, 26810, 29789) ],
                   [ cdf!(1865, 1988, 2930, 4242, 10533, 16538, 21354,
                                 27255, 28546, 31784),
                     cdf!(2979, 5958, 8937, 11916, 14895, 17873, 20852,
                                 23831, 26810, 29789) ] ],
                 [ [ cdf!(696, 948, 3145, 5702, 9706, 13217, 17851,
                                 21856, 25692, 28034),
                     cdf!(2979, 5958, 8937, 11916, 14895, 17873, 20852,
                                 23831, 26810, 29789) ],
                   [ cdf!(2672, 3591, 9330, 17084, 22725, 24284, 26527,
                                 28027, 28377, 30876),
                     cdf!(2979, 5958, 8937, 11916, 14895, 17873, 20852,
                                 23831, 26810, 29789) ] ],
                 [ [ cdf!(2784, 3831, 7041, 10521, 14847, 18844, 23155,
                                 26682, 29229, 31045),
                     cdf!(2979, 5958, 8937, 11916, 14895, 17873, 20852,
                                 23831, 26810, 29789) ],
                   [ cdf!(9577, 12466, 17739, 20750, 22061, 23215, 24601,
                                 25483, 25843, 32056),
                     cdf!(2979, 5958, 8937, 11916, 14895, 17873, 20852,
                                 23831, 26810, 29789) ] ],
                 [ [ cdf!(6698, 8334, 11961, 15762, 20186, 23862, 27434,
                                 29326, 31082, 32050),
                     cdf!(2979, 5958, 8937, 11916, 14895, 17873, 20852,
                                 23831, 26810, 29789) ],
                   [ cdf!(20569, 22426, 25569, 26859, 28053, 28913,
                                 29486, 29724, 29807, 32570),
                     cdf!(2979, 5958, 8937, 11916, 14895, 17873, 20852,
                                 23831, 26810, 29789) ] ] ];

pub static av1_default_coeff_lps_multi_cdfs: [[[[[u16; cdf_size!(BR_CDF_SIZE)]; LEVEL_CONTEXTS]; PLANE_TYPES]; TxSize::TX_SIZES]; TOKEN_CDF_Q_CTXS] = [
      [ [ [ cdf!(14298, 20718, 24174),
        ...
        [ [ cdf!(2331, 3662, 5244),
          ...
          [ cdf!(5842, 9229, 10838),
            ...
            cdf!(4870, 9636, 13205) ] ],
        [ [ cdf!(8192, 16384, 24576), cdf!(8192, 16384, 24576),
            cdf!(8192, 16384, 24576), cdf!(8192, 16384, 24576),
            cdf!(8192, 16384, 24576), cdf!(8192, 16384, 24576),
            cdf!(8192, 16384, 24576), cdf!(8192, 16384, 24576),
            cdf!(8192, 16384, 24576), cdf!(8192, 16384, 24576),
...
pub static av1_default_coeff_base_multi_cdfs: 
  [[[[[u16; cdf_size!(NUM_BASE_LEVELS + 2)]; SIG_COEF_CONTEXTS]; PLANE_TYPES]; TxSize::TX_SIZES]; TOKEN_CDF_Q_CTXS] =
        [ [ [ [ cdf!(4034, 8930, 12727),
...
pub static av1_default_coeff_base_eob_multi_cdfs: 
    [[[[[u16; cdf_size!(NUM_BASE_LEVELS + 1)]; SIG_COEF_CONTEXTS_EOB]; PLANE_TYPES]; TxSize::TX_SIZES]; TOKEN_CDF_Q_CTXS] = [ 
                                  [ [ [ cdf!(17837, 29055),
                                        cdf!(29600, 31446),
                                        cdf!(30844, 31878),
                                        cdf!(24926, 28948) ],
